      ...
      <div className="static-container">
        ...
        <div className="disclaimer-content">
          <section className="disclaimer-section">
            ...
            <p>
              <strong>xavflix does not host any files on its server.</strong> All content provided on this platform 
          ...
          <section className="disclaimer-section">
            ...
            <p>
              ...
              no liability in respect of any such content. All content available through xavflix remains 
            ...
            <p>
              ...
              site belong to their respective owners. xavflix makes no claims to own or control the 
          ...
          <section className="disclaimer-section">
            ...
            <p>
              This site is provided for entertainment and educational purposes only. xavflix is a 
          ...
          <section className="disclaimer-section">
            ...
            <p>
              Users of xavflix are solely responsible for:
            </p>
          ...
          <section className="disclaimer-section">
            ...
            <p>
              xavflix utilizes The Movie Database (TMDB) API for movie and TV show information, including:
            </p>
          ...
          <section className="disclaimer-section warning-section">
            <div className="warning-banner">
              ...
              <p>
                The developers of xavflix are not responsible for any legal issues that may arise from 
