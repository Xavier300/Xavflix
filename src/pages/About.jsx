      ...
      <div className="static-container">
        ...
        <div className="about-content">
          <section className="about-section">
            <h2>Welcome to xavflix</h2>
            <p>
              Welcome to xavflix, your favorite destination for exploring the vast world of Movies and TV shows. 
          ...
          <section className="about-section">
            ...
            <p>
              xavflix is developed as a demonstration of modern web development practices and is intended 
