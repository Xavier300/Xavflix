...
### Other Images
<img alt="Trending Today" src="public/img/trendingToday.webp"/>
<img alt="Trending This Week" src="public/img/trendingWeek.webp"/>
<img alt="Movies" src="public/img/movieswithFilter.webp"/>
<img alt="TV Shows" src="public/img/tvShowswithFilter.webp"/>
<img alt="Popular" src="public/img/popularwithFilter.webp"/>
...
- Host your own instance of <a href="https://xavflix.pages.dev/">xavflix</a> on Cloudflare.
- Fork this repository.
- Go to Cloudflare >> Workers and Pages >> Create application >> Pages >> Import an Existing Git Repository
- Project Name: `xavflix or whatever name you want - just make sure to edit wrangler.jsonc`
- Production Branch: `main`
- Framework Preset: `None`
- Build Command: `npm run build`
- Build Output Directory: `dist`
- Root Directory: `xavflix`
